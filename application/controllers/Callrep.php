...
class Callrep extends CI_Controller
{
    ...
    public function dashboard()
    {
        if ($this->session->userdata('logged_in') == true) {
            if ($this->session->userdata('roleid') == 5) {
                ...
                $this->load->view('callcenter_rep/header', $data);
                $this->load->view('callcenter_rep/dashboard');
                $this->load->view('callcenter_rep/footer');
            } else {
    ...
    public function users()
    {
        if ($this->session->userdata('logged_in') == true) {
            if ($this->session->userdata('roleid') == 5) {
                ...
                $this->load->view('callcenter_rep/header', $data);
                $this->load->view('callcenter_rep/users');
                $this->load->view('callcenter_rep/footer');
            } else {
                redirect(base_url() . 'admin', 'refresh');
    ...
    public function customer()
    {
        if ($this->session->userdata('logged_in') == true) {
            if ($this->session->userdata('roleid') == 5) {
                ...
                $this->load->view('callcenter_rep/header', $data);
                $this->load->view('callcenter_rep/customer');
                $this->load->view('callcenter_rep/footer');
            } else {
                redirect(base_url() . 'admin', 'refresh');
    ...
    public function orders()
    {
        if ($this->session->userdata('logged_in') == true) {
            if ($this->session->userdata('roleid') == 5) {
                ...
                $this->load->view('callcenter_rep/header', $data);
                $this->load->view('callcenter_rep/orders');
                $this->load->view('callcenter_rep/footer');
            } else {
                redirect(base_url() . 'admin', 'refresh');
    ...
    public function vouchers()
    {
        if ($this->session->userdata('logged_in') == true) {
            if ($this->session->userdata('roleid') == 5) {
                ...
                $this->load->view('callcenter_rep/header', $data);
                $this->load->view('callcenter_rep/vouchers');
                $this->load->view('callcenter_rep/footer');
            } else {
                redirect(base_url() . 'admin', 'refresh');
    ...
    public function loyalty()
    {
        if ($this->session->userdata('logged_in') == true) {
            if ($this->session->userdata('roleid') == 5) {
                ...
                $this->load->view('callcenter_rep/header', $data);
                $this->load->view('callcenter_rep/loyaltycard', $query);
                $this->load->view('callcenter_rep/footer');
            } else {
                redirect(base_url() . 'admin', 'refresh');
    ...
    public function callLogs()
    {
        if ($this->session->userdata('logged_in') == true) {
            if ($this->session->userdata('roleid') == 5) {
                ...
                $this->load->view('callcenter_rep/header', $data);
                $this->load->view('callcenter_rep/callLogs');
                $this->load->view('callcenter_rep/footer');
            } else {
                redirect(base_url() . 'admin', 'refresh');
    ...
    public function eod_report()
    {
        if ($this->session->userdata('logged_in') == true) {
            if ($this->session->userdata('roleid') == 5) {
                ...
                $this->load->view('callcenter_rep/header', $data);
                $this->load->view('callcenter_rep/eodreport');
                $this->load->view('callcenter_rep/footer');
            } else {
                redirect(base_url() . 'admin', 'refresh');
    ...
    public function anniversary_orders()
    {
        if ($this->session->userdata('logged_in') == true) {
            if ($this->session->userdata('roleid') == 5) {
                ...
                $this->load->view('callcenter_rep/header', $data);
                $this->load->view('callcenter_rep/anniversaryorders');
                $this->load->view('callcenter_rep/footer');
            } else {
                redirect(base_url() . 'admin', 'refresh');
