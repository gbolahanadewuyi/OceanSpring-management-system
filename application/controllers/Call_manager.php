...
class Call_manager extends CI_Controller
{
    ...
    public function dashboard()
    {
        if ($this->session->userdata('logged_in') == true) {
            if ($this->session->userdata('roleid') == 3) {
                ...
                $this->load->view('callcenter_managers/header', $data);
                $this->load->view('callcenter_managers/dashboard');
                $this->load->view('callcenter_managers/footer');
            } else {
    ...
    public function users()
    {
        if ($this->session->userdata('logged_in') == true) {
            if ($this->session->userdata('roleid') == 3) {
                ...
                $this->load->view('callcenter_managers/header', $data);
                $this->load->view('callcenter_managers/users');
                $this->load->view('callcenter_managers/footer');
            } else {
                redirect(base_url() . 'admin', 'refresh');
    ...
    public function customer()
    {
        if ($this->session->userdata('logged_in') == true) {
            if ($this->session->userdata('roleid') == 3) {
                ...
                $this->load->view('callcenter_managers/header', $data);
                $this->load->view('callcenter_managers/customer');
                $this->load->view('callcenter_managers/footer');
            } else {
                redirect(base_url() . 'admin', 'refresh');
    ...
    public function orders()
    {
        if ($this->session->userdata('logged_in') == true) {
            if ($this->session->userdata('roleid') == 3) {
                ...
                $this->load->view('callcenter_managers/header', $data);
                $this->load->view('callcenter_managers/orders');
                $this->load->view('callcenter_managers/footer');
            } else {
                redirect(base_url() . 'admin', 'refresh');
    ...
    public function vouchers()
    {
        if ($this->session->userdata('logged_in') == true) {
            if ($this->session->userdata('roleid') == 3) {
                ...
                $this->load->view('callcenter_managers/header', $data);
                $this->load->view('callcenter_managers/vouchers');
                $this->load->view('callcenter_managers/footer');
            } else {
                redirect(base_url() . 'admin', 'refresh');
    ...
    public function loyalty()
    {
        if ($this->session->userdata('logged_in') == true) {
            if ($this->session->userdata('roleid') == 3) {
                ...
                $this->load->view('callcenter_managers/header', $data);
                $this->load->view('callcenter_managers/loyaltycard', $query);
                $this->load->view('callcenter_managers/footer');
            } else {
                redirect(base_url() . 'admin', 'refresh');
    ...
    public function callLogs()
    {
        if ($this->session->userdata('logged_in') == true) {
            if ($this->session->userdata('roleid') == 3) {
                ...
                $this->load->view('callcenter_managers/header', $data);
                $this->load->view('callcenter_managers/callLogs');
                $this->load->view('callcenter_managers/footer');
            } else {
                redirect(base_url() . 'admin', 'refresh');
    ...
    public function callreps()
    {
        if ($this->session->userdata('logged_in') == true) {
            if ($this->session->userdata('roleid') == 3) {
                ...
                $this->load->view('callcenter_managers/header', $data);
                $this->load->view('callcenter_managers/callreps');
                $this->load->view('callcenter_managers/footer');
            } else {
                redirect(base_url() . 'admin', 'refresh');
    ...
    public function eod_report()
    {
        if ($this->session->userdata('logged_in') == true) {
            if ($this->session->userdata('roleid') == 3) {
                ...
                $this->load->view('callcenter_managers/header', $data);
                $this->load->view('callcenter_managers/eodreport');
                $this->load->view('callcenter_managers/footer');
            } else {
                redirect(base_url() . 'admin', 'refresh');
    ...
    public function anniversary_orders()
    {
        if ($this->session->userdata('logged_in') == true) {
            if ($this->session->userdata('roleid') == 3) {
                ...
                $this->load->view('callcenter_managers/header', $data);
                $this->load->view('callcenter_managers/anniversaryorders');
                $this->load->view('callcenter_managers/footer');
            } else {
                redirect(base_url() . 'admin', 'refresh');
    ...
    public function stock()
    {
        if ($this->session->userdata('logged_in') == true) {
            if ($this->session->userdata('roleid') == 3) {
                ...
                $this->load->view('callcenter_managers/header', $data);
                $this->load->view('callcenter_managers/stock', $query);
                $this->load->view('callcenter_managers/footer');
            } else {
                redirect(base_url() . 'admin', 'refresh');
