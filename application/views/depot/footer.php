...
<script src="<?=base_url()?>dashboard/requests/depot/depotdashboard.js"></script>
...
<?php if (base_url() . 'depot/eod_report' == current_url()): ?>
<script src="<?=base_url()?>dashboard/requests/depot/eodreport.js"></script>

<?php endif;?>



<?php if (base_url() . 'depot/stock' == current_url()): ?>
<script>
// Morris.Bar({
//     element: 'graph',
//     data: [{
...
<script src="<?=base_url()?>dashboard/requests/depot/stock.js"></script>
