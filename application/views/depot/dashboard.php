...
<ul class="sidebar-menu" data-widget="tree">
    ...
    <!-- Optionally, you can add icons to the links -->
    <li class="active"><a href="<?= base_url() ?>depot/dashboard"><i class="fa fa-area-chart"></i>
            <span>Dashboard</span></a></li>
    <li class=""><a href="<?=base_url()?>depot/stock"><i class="fa fa-book"></i> <span>Stock
            </span></a></li>
