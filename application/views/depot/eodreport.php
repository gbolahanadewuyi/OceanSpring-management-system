<ul class="sidebar-menu" data-widget="tree">
    ...
    <li><a href="<?=base_url()?>depot/stock"><i class="fa fa-book"></i> <span>Stock
            </span></a></li>

    <li class="active"><a href="<?= base_url() ?>depot/eod_report"><i class="fa fa-cogs"></i> <span>EOD
                Report</span></a></li>
</ul>
<!-- /.sidebar-menu -->
</section>
                ...
                <div class="box">
                    ...
                    <div class="box-body no-padding">
                        <table class="table table-striped">
                            ...
                            <tr>
                                <td>1.</td>
                                <td>Stock Recieved</td>
                                <td><span class="SR badge bg-light-blue ">0</span></td>
                                <!-- <td>
                            ...
                            <tr>
                                ...
                                <td><span class="SD badge bg-light-blue ">0</span></td>
                                <!-- <td>
                                                <div class="progress progress-xs">
                            ...
                            <tr>
                                <td>3.</td>
                                <td>Stock Damaged</td>
                                <td><span class="SDA badge bg-light-blue ">0</span></td>
                                <!-- <td>
