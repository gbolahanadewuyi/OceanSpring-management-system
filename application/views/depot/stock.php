<ul class="sidebar-menu" data-widget="tree">
    ...
    <li class=""><a href="<?=base_url()?>depot/dashboard"><i class="fa fa-area-chart"></i>
            <span>Dashboard</span></a></li>
    <li class="active"><a href="<?=base_url()?>depot/stock"><i class="fa fa-book"></i> <span>Stock
            </span></a></li>

    <li><a href="<?=base_url()?>depot/eod_report"><i class="fa fa-cogs"></i> <span>EOD Report</span></a></li>
</ul>
<!-- /.sidebar-menu -->
</section>
<!-- /.sidebar -->
                        ...
                        <form role="form" method="POST" action="JavaScript:checkSTOCK();" id="d-stockform">
                            ...
                            <div class="form-group">
                                ...
                                <select id="Dtype" name="" class="form-control select2" style="width: 100%;"
                                    ...
                                    <option value="ZONE">Zonal Dispatch
                                    </option>
                            ...
                            <div class="form-group" id='zone'>
                                <label control-label>Recieving Zone:</label>
                                <select id="RRzone" name="" class="form-control select2" style="width: 100%;">

                                    <option selected="selected" value="">-- Select Zone --
                                    </option>
