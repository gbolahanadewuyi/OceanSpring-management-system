...
<?php if (base_url() . 'depot/dashboard' == current_url()): ?>
<script src="<?=base_url()?>dashboard/js/dashboard.js"></script>

<?php endif;?>

<?php if (base_url() . 'authdealer/orders' == current_url()): ?>
<script src="<?=base_url()?>dashboard/requests/authdealer/order.js"></script>

<?php endif;?>

<?php if (base_url() . 'authdealer/eod_report' == current_url()): ?>
<script src="<?=base_url()?>dashboard/requests/authdealer/eodreport.js"></script>

<?php endif;?>



<?php if (base_url() . 'authdealer/stock' == current_url()): ?>
<script>
Morris.Bar({
    element: 'graph',
    data: [{
...
<script src="<?=base_url()?>dashboard/requests/authdealer/stock.js"></script>
