<ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="active"><a href="<?= base_url() ?>call_manager/dashboard"><i class="fa fa-area-chart"></i>
    ...
    <li class=""><a href="<?=base_url()?>call_manager/callreps"><i class="fa fa-user-secret"></i> <span>Call
                Reps</span></a></li>
    <li class="active"><a href="<?=base_url()?>call_manager/stock"><i class="fa fa-book"></i> <span>Stock
            </span></a></li>
