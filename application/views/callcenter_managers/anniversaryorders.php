<ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="active"><a href="<?= base_url() ?>call_manager/anniversary_orders"><i class="fa fa-book"></i>
    ...
    <li class=""><a href="<?= base_url() ?>call_manager/eod_report"><i class="fa fa-cogs"></i> <span>EOD
                Report</span></a></li>
