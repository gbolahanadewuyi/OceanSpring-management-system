<ul class="sidebar-menu" data-widget="tree">
    ...
    <li class=""><a href="<?= base_url() ?>call_manager/dashboard"><i class="fa fa-area-chart"></i> <span>Dashboard</span></a></li>
    <li class=""><a href="<?= base_url() ?>call_manager/users"><i class="fa fa-group"></i> <span>New Users</span></a></li>
    <li class="active"><a href="<?= base_url() ?>call_manager/customer"><i class="fa fa-user"></i> <span>Customers</span></a></li>
    <li class=""><a href="<?= base_url() ?>call_manager/orders"><i class="fa fa-book"></i> <span>Orders</span></a></li>
    <li class=""><a href="<?= base_url() ?>call_manager/anniversary_orders"><i class="fa fa-book"></i> <span>Anniversary</span></a></li>
    <li class=""><a href="<?= base_url() ?>call_manager/callLogs"><i class="fa fa-phone"></i> <span>Call Logs</span></a></li>
