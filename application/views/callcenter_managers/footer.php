...
<?php if (base_url() . 'call_manager/dashboard' == current_url()) : ?>
<script src="<?= base_url() ?>dashboard/requests/callcenter_managers/cmdashboard.js"></script>
<script src="<?= base_url() ?>dashboard/js/dashboard.js"></script>

<?php endif; ?>

<?php if (base_url() . 'call_manager/users' == current_url()) : ?>
<script src="<?= base_url() ?>dashboard/requests/callcenter_managers/customer.js"></script>
<script src="<?= base_url() ?>dashboard/requests/callcenter_managers/user.js"></script>
<?php endif; ?>

<!-- <?php if (base_url() . 'call_manager/users#tab_2' == current_url()) : ?>
<script src="<?= base_url() ?>dashboard/requests/callcenter_managers/customer.js"></script>
<?php endif; ?> -->



<?php if (base_url() . 'call_manager/customer' == current_url()) : ?>
<script src="<?= base_url() ?>dashboard/requests/callcenter_managers/customer.js"></script>

<?php endif; ?>

<?php if (base_url() . 'call_manager/orders' == current_url()) : ?>
<script src="<?= base_url() ?>dashboard/requests/callcenter_managers/order.js"></script>

<?php endif; ?>

<?php if (base_url() . 'call_manager/vouchers' == current_url()) : ?>
<script src="<?= base_url() ?>dashboard/requests/callcenter_managers/voucher.js"></script>

<?php endif; ?>

<?php if (base_url() . 'call_manager/callLogs' == current_url()) : ?>
<script src="<?= base_url() ?>dashboard/requests/callcenter_managers/calllog.js"></script>

<?php endif; ?>

<?php if (base_url() . 'call_manager/eod_report' == current_url()) : ?>
<script src="<?= base_url() ?>dashboard/requests/callcenter_managers/eodreport.js"></script>

<?php endif; ?>

<?php if (base_url() . 'call_manager/anniversary_orders' == current_url()) : ?>
<script src="<?= base_url() ?>dashboard/requests/callcenter_managers/anniversary.js"></script>

<?php endif; ?>

<?php if (base_url() . 'call_manager/callreps' == current_url()) : ?>
<script src="<?= base_url() ?>dashboard/requests/callcenter_managers/callrep.js"></script>

<?php endif; ?>

<?php if (base_url() . 'call_manager/loyalty' == current_url()) : ?>
<script>
Morris.Bar({
    element: 'graph',
    data: [{
...
<script src="<?= base_url() ?>dashboard/requests/callcenter_managers/loyalty.js"></script>

<?php endif; ?>



<?php if (base_url() . 'call_manager/stock' == current_url()) : ?>
<script>
Morris.Bar({
    element: 'graph',
    data: [{
...
<script src="<?= base_url() ?>dashboard/requests/callcenter_managers/stock.js"></script>
