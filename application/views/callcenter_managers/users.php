...
<ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="active"><a href="<?=base_url()?>call_manager/users"><i class="fa fa-group"></i> <span>New
                Users</span></a></li>
                                    ...
                                    <div class="col-xs-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="Example 0255444444" class="form-control"
                                                    id="alt_phone" placeholder="">
                                            </div>
                        ...
                        <zg-colgroup>
                            ...
                            <zg-column index="msisdn,id" header="Action" editor="false">
                                <zg-button onclick='customer_info([[index.msisdn]],)'>
                                    <zg-icon name="info"> </zg-icon> <span>Info</span>
                                </zg-button>
                                ...
                                <zg-button onclick='delete_customer([[index.id]],)'>
                                    <zg-icon name="close"> </zg-icon> <span>Delete</span>
                                </zg-button>
