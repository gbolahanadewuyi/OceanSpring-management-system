<ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="active"><a href="<?=base_url()?>zonalmanager/sea"><i class="fa fa-users"></i> <span>Sales
                Executive Assistants</span></a>
    </li>

    <li class=""><a href="<?=base_url()?>zonalmanager/riders"><i class="fa fa-users"></i> <span>Riders
                </span></a>
    </li>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Sales Executive Assistants
            <small>Control panel</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li class="active">SEA</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li class="active"><a href="#tab_1" data-toggle="tab">S.E.A</a></li>
                <li><a href="#tab_2" data-toggle="tab">Add S.E.A</a></li>
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab_1">
                    ...
                    <zing-grid editor="modal" layout="row" layout-controls='true' search filter sort pager
                        ...
                        <!-- <zg-caption>
                            <i class="fa fa-user"></i> Sales Executive Assistants -->
                ...
                <div class="tab-pane" id="tab_2">
                    <div class="box box-primary">
                        ...
                        <form role="form" method="post" action="javaScript:add_sea();" enctype="multipart/form-data"
                            id="sea-form">
                            <div class="box-body">
                                    ...
                                    <div class="col-xs-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="" class="form-control" id="SEAname"
                                    ...
                                    <div class="col-xs-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="" class="form-control" id="SEAphone"
                                                    placeholder="" required>
                                            </div>
                                    ...
                                    <div class="col-xs-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="email" name="" class="form-control" id="SEAemail"
                                                    placeholder="">
                                            </div>
                                    ...
                                    <div class="col-xs-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="" class="form-control" id="SEAusername"
                                                    placeholder="" required>
                                            </div>
                                ...
                                <input type ="text" id ="SEArole" style="display:none;">
                            ...
                            <div class="box-footer">
                                ...
                                <button type="submit" id="btnSave" class="btn btn-primary pull-right">Save
                                    changes</button>
                            </div>
                        </form>
                    </div>
