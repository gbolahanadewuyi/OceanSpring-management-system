<ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="active"><a href="<?=base_url()?>zonalmanager/loyalty"><i class="fa fa-credit-card"></i> <span>Loyalty
                Cards</span></a></li>
    ...
    <section class="content">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li class="active"><a href="#tab_1 " data-toggle="tab">Loyalty Growth</a></li>
                <li><a href="#" data-toggle="tab"> Assign Loyalty Number</a></li>
