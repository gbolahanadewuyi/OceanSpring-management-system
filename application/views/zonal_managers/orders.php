...
<ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="active"><a href="<?= base_url() ?>zonalmanager/orders"><i class="fa fa-book"></i> <span>Orders</span></a>
    </li>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="tab_2">
                    ...
                    <div class="box-footer">
                        ...
                        <button type="submit" id="btnSaveOrder" class="showBTN btn btn-primary pull-right">Save
                            changes</button>
                    </div>
                    </form>
                </div>
