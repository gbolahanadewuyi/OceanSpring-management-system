...
<ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="active"><a href="<?= base_url() ?>callrep/users"><i class="fa fa-group"></i> <span>New Users</span></a>
    </li>
    ...
    <section class="content">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li class="active"><a href="#tab_1" data-toggle="tab">Register Customer</a></li>
                <li class=""><a href="#tab_2" data-toggle="tab">Registered Customers</a></li>
                <li><a href="#tab_3" data-toggle="tab">Users Registered via USSD</a></li>
            ...
            <div class="tab-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="for" id="for" value="daily" >
                                                    Daily
                                                </label>
                                            </div>
                                            <div class="radio">
                ...
                <div class="tab-pane " id="tab_2">
                    <zing-grid editor="modal" layout="row" id="customer_table" layout-controls='true' search filter sort
                        pager page-size="20" page-size-options="30,40,50,60">
                        <zg-caption>
                ...
                <div class="tab-pane" id="tab_3">
                    <zing-grid editor="modal" layout="row" layout-controls='true' id="ussd-table" search filter sort
                        pager page-size="20" page-size-options="20,40,60,80">
                        <zg-caption>
                            <!-- <i class="fa fa-user"></i> Registrations via USSD . -->
