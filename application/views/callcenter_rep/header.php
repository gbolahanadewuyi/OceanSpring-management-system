...
<head>
    ...
    zing-grid {
        ...
        --zg-button-background_custom_active: #EF5350;
        --zg-button-color_custom_hover: #EF5350;
        --zg-cell-color_hover: #EF5350;
        --zg-cell-label-color_layout_card: #EF5350;
        --zg-cell-label-font-size_layout_card: 20px;
