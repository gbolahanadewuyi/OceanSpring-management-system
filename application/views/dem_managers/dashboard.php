...
<ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="active"><a href="<?= base_url() ?>dem_manager/dashboard"><i class="fa fa-area-chart"></i> <span>Dashboard</span></a></li>
    <li class=""><a href="<?= base_url() ?>dem_manager/orders"><i class="fa fa-book"></i> <span>Orders</span></a></li>
    <li><a href="<?= base_url() ?>dem_manager/eod_report"><i class="fa fa-cogs"></i> <span>EOD Report</span></a></li>
</ul>
<!-- /.sidebar-menu -->
</section>
<!-- /.sidebar -->
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-gray">
                    <div class="inner">
                        <h3 id="total_streams_count">0</h3>
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-gray">
                    <div class="inner">
                        <h3 id="total_membership_count">0</h3>
