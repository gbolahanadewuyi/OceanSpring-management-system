...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url()?>dashboard/kendoui/styles/kendo.common.min.css" />
    <link rel="stylesheet" href="<?= base_url()?>dashboard/kendoui/styles/kendo.default.min.css" />
    <link rel="stylesheet" href="<?= base_url()?>dashboard/kendoui/styles/kendo.default.mobile.min.css" />

    <script src="<?= base_url()?>dashboard/kendoui/js/jquery.min.js"></script>
    <script src="<?= base_url()?>dashboard/kendoui/js/kendo.all.min.js"></script>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span class="hidden-xs" id="" >John Doe</span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
                                <li class="user-header">
                                    <img src="<?= base_url()?>dashboard/images/prof-pic.png" class="img-circle" alt="User Image" id="prof-pic">
                                ...
                                <li class="user-footer">
                                    ...
                                    <div class="pull-right">
                                        <a href="javascript:void(0)" onclick="end_session()" class="btn btn-default btn-flat">Sign out</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
