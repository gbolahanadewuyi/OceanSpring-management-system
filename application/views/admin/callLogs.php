<ul class="sidebar-menu" data-widget="tree">
    ...
    <li class=""><a href="<?= base_url() ?>admin/dashboard"><i class="fa fa-area-chart"></i> <span>Dashboard</span></a></li>
    <li class=""><a href="<?= base_url() ?>admin/users"><i class="fa fa-group"></i> <span>New Users</span></a></li>
    <li class=""><a href="<?= base_url() ?>admin/customer"><i class="fa fa-user"></i> <span>Customers</span></a></li>
    <li class=""><a href="<?= base_url() ?>admin/orders"><i class="fa fa-book"></i> <span>Orders</span></a></li>
    <li class=""><a href="<?= base_url() ?>admin/anniversary_orders"><i class="fa fa-book"></i> <span>Anniversary</span></a></li>
    ...
    <li class=""><a href="<?= base_url() ?>admin/create_user"><i class="fa fa-book"></i> <span>Create User</span></a></li>
    <li class="active"><a href="<?= base_url() ?>admin/callLogs"><i class="fa fa-phone"></i> <span>Call Logs</span></a></li>
    ...
    <li class="treeview">
        <a href="#"><i class="fa fa-male"></i> <span>Pastors</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
            </span>
        </a>
        <ul class="treeview-menu">
            <li><a href="#">View Pastor</a></li>
            <li><a href="#">Add Pastor</a></li>
        </ul>
    </li> -->
...
<div class="content-wrapper">
    ...
    <zing-grid editor="modal"  layout="row"  layout-controls='true' search filter sort pager page-size="20" page-size-options="20,40,60,80">
                        <zg-caption>
                            <a class=" btn bg-purple  margin  pull-right" style="color:white;"  data-toggle="modal" data-target="#callmodal"><i class="fa fa-plus"></i>
                    Call Log </a>
                        </zg-caption>


                        <zg-colgroup>
                            <zg-column index="dateofcall" header="Date of Call" type="text" renderer="_renderClassActivity"></zg-column>
                    ...
                    <div class="modal-body">
                        <form role="form" method="POST" action="JavaScript:LogCall();" id="callogForm">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="customerNumber" id="cusmobile" placeholder="" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="feedback" name="nationality" class="form-control select2" style="width: 100%;">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="feedback" id="comment" rows="5" placeholder="Enter comment made by customer" required> </textarea>

                            </div>
                            <div class="form-group">
                                <label class="control-label">Operator name:</label>
                                <select id="opname" name="nationality" class="form-control select2" style="width: 100%;">
                            ...
                            <div class="form-group">
                                <label class="control-label">Operator number:</label>
                                <select id="opnumber" name="nationality" class="form-control select2" style="width: 100%;">
