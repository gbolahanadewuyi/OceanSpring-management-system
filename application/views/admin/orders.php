<ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="active"><a href="<?= base_url() ?>admin/orders"><i class="fa fa-book"></i> <span>Orders</span></a></li>
...
<div class="content-wrapper">
    ...
    <section class="content">
        <zing-grid editor="modal" row-class="_renderClassActivity" layout="row" layout-controls='true' search filter
            sort pager page-size="20" page-size-options="20,40,60,80">
            <zg-caption>
            ...
            <zg-colgroup>
                ...
                <zg-column index="datetime" header="Date" sort-desc = "true"></zg-column>
